...
(nextval('categories_id_seq'), 'Продукты'),
(nextval('categories_id_seq'), 'Прочее');
...
Цена, количество, всего:
%PRODUCT_PRICE% ₽ * %PRODUCT_QUANTITY% шт. = %PRODUCT_TOTAL_PRICE% ₽'),
(nextval('messages_id_seq'), 'PRODUCT_MESSAGE', 'Product', '<a href="%PRODUCT_PHOTO_URL%"> </a>
<b>Наименование продукта</b>: %PRODUCT_NAME%
