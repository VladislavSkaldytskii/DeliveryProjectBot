...
public class OrderEnterPhoneNumberCommandHandler implements CommandHandler, UpdateHandler, ActionHandler {
    ...
    @Autowired
    public OrderEnterPhoneNumberCommandHandler(@Lazy CommandHandlerRegistry commandHandlerRegistry, ClientActionRepository clientActionRepository, ClientCommandStateRepository clientCommandStateRepository, ClientOrderStateRepository clientOrderStateRepository) {
    ...
    private void sendEnterPhoneNumberMessage(AbsSender absSender, Long chatId) throws TelegramApiException {
        SendMessage message = SendMessage.builder()
                .chatId(chatId)
                .text("Введите номер телефона нажмите на кнопку")
