...
public class OrderEnterCityCommandHandler implements CommandHandler, ActionHandler {
    ...
    @Autowired
    public OrderEnterCityCommandHandler(@Lazy CommandHandlerRegistry commandHandlerRegistry, ClientActionRepository clientActionRepository, ClientCommandStateRepository clientCommandStateRepository, ClientOrderStateRepository clientOrderStateRepository) {
