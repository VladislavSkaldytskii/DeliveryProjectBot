...
public class OrderEnterNameCommandHandler implements CommandHandler, ActionHandler {
    ...
    @Autowired
    public OrderEnterNameCommandHandler(@Lazy CommandHandlerRegistry commandHandlerRegistry, ClientActionRepository clientActionRepository, ClientCommandStateRepository clientCommandStateRepository, ClientOrderStateRepository clientOrderStateRepository) {
